    ...
    >
      ...
      <div className="bg-slate-950 border border-solid border-blue-400 rounded-lg flex flex-col">
        <button
          ...
          className="relative px-4  p-3 flex items-center justify-center"
        >
        ...
        {Object.keys(SCHEMES).map((scheme, schemeIndex) => {
          return (
            <button
              ...
              className={
                "bg-slate-950 px-4 border  duration-200 px-4 hover:border-blue-600 py-3 rounded-lg " +
